...
import BledgerSketches from '../assets/bledger/Bledger-Sketchbook.png';
...
import LobbyTabletDarkFull from '../assets/vibespace/mockups/lobby-tablet-dark-full.png';
import LobbyTabletLightFull from '../assets/vibespace/mockups/lobby-tablet-light-full.png';
...
import WaitingtabletDarkFull from '../assets/vibespace/mockups/waiting-tablet-dark-full.png';
import WaitingTabletLightFull from '../assets/vibespace/mockups/waiting-tablet-light-full.png';
...
export const ProjectData = {
    p1:{
        ...
        empathy:
        {
            ...
            persona2:' Ben Thompson Age: 35 Occupation: Rideshare Driver Location: Atlanta, GA Background: Ben relies on rideshare driving for income but faces unpredictable earnings due to fluctuating demand and expenses like car maintenance. He struggles to save consistently and often feels overwhelmed by financial management. Goals: Create a stable budget that adapts to his variable income and helps him save for future expenses. Pain Points: Difficulty tracking irregular income; stressed about unexpected costs. Behaviors: Uses budgeting apps but finds them too rigid; values real-time insights and actionable advice. Quote: "I need a budget that understands my hustle and helps me stay ahead of the game."',
        ...
        define:
        {
            ...
            HypothesisStatement:'If we provide Ben with a glanceable, agentic AI dashboard that predicts overspending and autonomously safeguards bill payments, then he will experience reduced financial anxiety and fewer late fees, regardless of his weekly income volatility.',
