import BledgerHero from '/src/assets/Bledger-board.png';
import BledgerSketches from '/src/assets/bledger/Bledger-Sketchbook.png';
import BledgerAudit from '/src/assets/bledger/Bledger-competitive-audit.png';
import BledgerEmpathy from '/src/assets/bledger/Bledger-empathy-map.png';
import BledgerHome from '/src/assets/bledger/Bledger-Home.png';
import BledgerHomeDark from '/src/assets/bledger/Bledger-home-dark-mode.png';
import BLedgerWireframe1 from '/src/assets/bledger/bledger-wireframe1.png';
import BledgerWireframe2 from '/src/assets/bledger/bledger-wireframe2.png';
import BledgerHomeFinal from '/src/assets/bledger/Bledger-home-final.png';
import BledgerIA from '/src/assets/bledger/Bledger-info-arch.png';
import BledgerInsights from '/src/assets/bledger/Bledger-Insights.png';
import BledgerInsightDark from '/src/assets/bledger/Bledger-insights-dark-mode.png';
import BledgerInsightsFinal from '/src/assets/bledger/Bledger-insights-final.png';
import BledgerV1 from '/src/assets/bledger/Bledger-iteration1.png';
import BledgerV2 from '/src/assets/bledger/Bledger-iteration2.png';
import BledgerV3 from '/src/assets/bledger/Bledger-iteration3.png';
import BledgerV4 from '/src/assets/bledger/Bledger-iteration4.png';
import BledgerJamal from '/src/assets/bledger/Bledger-jamal-thompson.png';
import BledgerJourney from '/src/assets/bledger/Bledger-journey-map.png';
import BledgerMaya from '/src/assets/bledger/Bledger-maya-rodriguez.png';
import BledgerSettings from '/src/assets/bledger/Bledger-settings.png';
import BledgerSettingsDark from '/src/assets/bledger/Bledger-setting-darkmode.png';
import BledgerSettingsFinal from '/src/assets/bledger/Bledger-settings-final.png';
import Bledgertracker from '/src/assets/bledger/Bledger-tracker.png';
import BledgerTrackerDark from '/src/assets/bledger/Bledger-tracker-dark.png';
import BledgerTrackerFinal from '/src/assets/bledger/Bledger-tracker-final.png';

//Bledger Mock-ups
import BledgerHomeDMock from '/src/assets/bledger/mockups/iPhone-3q-view1.png'; 
import BledgerInsightsMock from '/src/assets/bledger/mockups/iPhone-3q-view2.png';
import BledgerTrackerMock from '/src/assets/bledger/mockups/iPhone-3q-view3.png';
import BledgerHomeMockFull from '/src/assets/bledger/mockups/iPhone-gray.png';
import BledgerTrackerMockFull from '/src/assets/bledger/mockups/iPhone-gray-1.png';
import BledgerInsightsMockFull from '/src/assets/bledger/mockups/iPhone-gray-2.png';
import BledgerSettingsMockFull from '/src/assets/bledger/mockups/iPhone-gray-3.png';
import BledgerSettings3QDark from '/src/assets/bledger/mockups/iPhone-gray-3Q.png';
import BledgerHome2QLIght from '/src/assets/bledger/mockups/iPhone-gray-3q1.png';
import BledgerTracker3QDark from '/src/assets/bledger/mockups/iPhone-gray-3q4.png';
import BledgerSettings3QLight from '/src/assets/bledger/mockups/iPhone-gray-3q5.png';
import BledgerInsights3QDark from '/src/assets/bledger/mockups/iPhone-gray-3q-view.png';
import BledgerHomeDarkFull from '/src/assets/bledger/mockups/iPhone-gray-4.png';
import BledgertrackerDarkFull from '/src/assets/bledger/mockups/iPhone-gray5.png';
import BledgerInsightsDarkFull from '/src/assets/bledger/mockups/iPhone-gray-6.png';
import BledgerSettingsDarkFull from '/src/assets/bledger/mockups/iPhone-gray-7.png';

//vibespace Design Images
import LobbyDesktopDark from '/src/assets/vibespace/lobby-desktop-darkmode.png';
import LobbyDesktopLight from '/src/assets/vibespace/lobby-desktop.png';
import LobbyMobileDark from '/src/assets/vibespace/lobby-mobile-DarkMode.png';
import ReadyMobileDark from '/src/assets/vibespace/lobby-ready-mobile - Dark Mode.png';
import ReadyMobileLight from '/src/assets/vibespace/lobby-ready-mobile.png';
import MatchDesktopDark from '/src/assets/vibespace/new-match-desktop-Dark Mode.png';
import MatchDesktopLight from '/src/assets/vibespace/new-match-desktop.png';
import MatchMobileDark from '/src/assets/vibespace/new-match-mobile-Dark Mode.png';
import MatchMobileLight from '/src/assets/vibespace/new-match-mobile.png';
import VibeCompetitiveAudit from '/src/assets/vibespace/vibe space-ca-image.jpg';
import VibeEmpathyMap1 from '/src/assets/vibespace/vibe space-emp-map1.png';
import VibeEmpathyMap2 from '/src/assets/vibespace/vibe space-emp-map2.png';
 import VibeEmpathyMap3 from '/src/assets/vibespace/vibe space-emp-map3.png';
 import VibeInfoArch from '/src/assets/vibespace/vibe space-Info-arch.png';
 import VibeIterationMobile1 from '/src/assets/vibespace/Vibespace-iteration1-mobile.png';
import VibeIterationMobile2 from '/src/assets/vibespace/Vibespace-iteration2-mobile.png';
import VibeIterationMobile3 from '/src/assets/vibespace/Vibespace-iteration3-mobile.png';
import VibeDesktopIteration1 from '/src/assets/vibespace/Vibespace-iteration4-desktop.png';
import VibeDesktopIteration2 from '/src/assets/vibespace/Vibespace-iteration5-desktop.png';
import VibeDesktopIteration3 from '/src/assets/vibespace/Vibespace-iteration6-desktop.png';
import VibeJourneyMap from '/src/assets/vibespace/vibe space-journey-map.png';
import VibePersona1 from '/src/assets/vibespace/vibe space-persona1.png';
import VibePersona2 from '/src/assets/vibespace/vibe space-persona2.png';
import VibeStudy from '/src/assets/vibespace/vibe space-study-image.png';
import VibeWireframes from '/src/assets/vibespace/vibe space-wireframes.png';
import VibeWaitingDesktopDark from '/src/assets/vibespace/waiting desktop-Dark Mode.png';
import VibeWaitingDesktopLight from '/src/assets/vibespace/waiting desktop.png';
import VibeWaitingMobileDark from '/src/assets/vibespace/waiting mobile-Dark Mode.png';

//Vibe Space Mock-ups
import LobbyDesk3QLight from '/src/assets/vibespace/mockups/Lobby-desktop-3q-light.png';
import LobbyMobileQDark from '/src/assets/vibespace/mockups/lobby-mobile-dark.png';
import LobbyMobileDarkFull from '/src/assets/vibespace/mockups/lobby-mobile-dark-full.png';
import LobbyMobileLight from '/src/assets/vibespace/mockups/lobby-mobile-light.png';
import LobbyMobileLightFull from '/src/assets/vibespace/mockups/lobby-mobile-light-full.png';
import LobbyTabletDark3Q from '/src/assets/vibespace/mockups/lobby-tablet-dark.png';
import LobbyTabletDarkFull from '/src/assets/vibespace/mockups/lobby-tablet-dark-full.png';
import LobbyTabletLightFull from '/src/assets/vibespace/mockups/lobby-tablet-light-full.png';
import MatchDesktop3QLight from '/src/assets/vibespace/mockups/match-desktop-light-3q.png';
import MatchMobileDark3Q from '/src/assets/vibespace/mockups/match-mobile-dark-3q.png';
import MatchMobileDarkFull from '/src/assets/vibespace/mockups/match-mobile-dark-full.png';
import MatchMobileLightFull from '/src/assets/vibespace/mockups/match-mobile-light-Full.png';
import MatchTabletDark3Q from '/src/assets/vibespace/mockups/match-tablet-dark-3q.png';
import MatchTabletDarkFull from '/src/assets/vibespace/mockups/match-tablet-dark-full.png';
import MatchTabletLight3Q from '/src/assets/vibespace/mockups/match-tablet-light-3q.png';
import MatchTabletLightFull from '/src/assets/vibespace/mockups/match-tablet-light-full.png';
import MatchMobileLight3Q from '/src/assets/vibespace/mockups/New Match-3Q.png';
import WaitingDesktopDark3Q from '/src/assets/vibespace/mockups/waiting-desktop-dark-3q.png';
import WaitingMobiledarkFull from '/src/assets/vibespace/mockups/waiting-mobile-dark-full.png';
import WaitingMobileLightFull from '/src/assets/vibespace/mockups/waiting-mobile-light-full.png';
import WaitingtabletDarkFull from '/src/assets/vibespace/mockups/waiting-tablet-dark-full.png';
import WaitingTabletLightFull from '/src/assets/vibespace/mockups/waiting-tablet-light-full.png';
import WaitingMobileDark3Q from '/src/assets/vibespace/mockups/waiting-mobile-dark-3q.png';
import WaitingMobileLight3Q from '/src/assets/vibespace/mockups/waiting-mobile-light-3q.png';    
...
export const ProjectData = {
    p1:{
        ...
        empathy:
        {
            ...
            journeyMapImage:BledgerJourney,
            ...
            empathyMapImage: BledgerEmpathy,
    ...
    p2:{
        ...
        { 
            ...
            testSummary: '- Participants appreciated the efficiency of the mandatory pre-session "Check-In" gate. - The state-aware JIT rerouting system was valued for reducing anxiety and ensuring no important sessions were missed.- Flexibility of the automated rerouting system was acknowledged, but time prioritization could be improved. - Participants recommended enhancements for the "Check-In" gate. - The systems led to an increase in session completion rates. - The automated rerouting system was considered crucial for better time management. - The event\'s organization and customization were recognized with the "Check-In" gate and rerouting system, leading to increased engagement with the event content.',
            conclusion:'- Overall, the combination of the "Check-In" gate and automated rerouting system positively impacted the event experience for participants. - Recommendations for improvements include enhancing time prioritization in the automated rerouting system and making enhancements to the "Check-In" gate. - Participants found value in the increased organization, customization, and engagement facilitated by the systems implemented. - The event-matching/networking web application was highly recommended based on the improved systems.'
        },
    },
};