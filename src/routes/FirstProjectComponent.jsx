    ...
    return (
        <div className="p-6 md:p-4 gap-6 bg-neutral-100/75 rounded-lg shadow-[2px_11px_6px_-4px_rgba(136,136,136,0.25)] outline outline-2px outline-zinc-500/40 mt-6 mx-auto max-w-6xl">
            ...
            className="w-full gap-4">
                ...
                <div className="text-left text-gray-600 gap-6">
                    <h2 className="gap-1 text-lg sm:text-xl text-gray-900 font-semibold">
                    ...
                    <h1 className="my-1 text-gray-900 font-semibold text-left text-lg sm:text-xl">
                        The Problem
                    </h1>
                    <p className="text-sm sm:text-base p-0">
                    ...
                    <h2 className=" text-gray-900 font-semibold text-base sm:text-lg">Target</h2>
                    <p className="text-sm sm:text-base">
                    ...
                    <p className="font-bold text-gray-900">Andres Pacheco</p>
                    <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Age: 37<br/>
                    ...
                    <h2 className="font-semibold mt-6 text-sm sm:text-base text-gray-900">Barbara's Goal</h2>
                    ...
                    <h2 className="font-semibold mt-4 text-gray-900 text-base sm:text-lg">Problem Statement</h2>
                    <p className="text-sm sm:text-base">
                    ...
                    <h2 className="font-semibold text-base sm:text-lg text-gray-900">Andres' Goal</h2>
                    <p className="text-sm sm:text-base">
                    ...
                    <h2 className="font-semibold text-base sm:text-lg text-gray-900">Problem Statement</h2>
                    <p className="text-sm sm:text-base">Andres is a survivalist who needs nature space to educate the community youth because current public spaces do not have the materials needed to teach his skills.
                    </p>
                    <div>
            ...
            <div className="gap-y-8">
                ...
                <div className="gap-4 sm:grid sm:grid-cols-3 sm:gap-4">
                    ...
                    <h2 className="mt-12 text-gray-900 font-semibold text-lg sm:text-xl">
