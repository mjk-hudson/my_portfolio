...
export default function Home() {
  return (
    <div className="p-4 max-w-7xl mx-auto pt-20 text-start">
      <h1 className="font-public-sans text-4xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
